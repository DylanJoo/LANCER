...
# query 
queries = {}
with open('/home/dju/lancer-legacy/data/crux-mds-duc04.request.jsonl', 'r') as f:
    for line in f:
...
# runs are provided
runs = {}
with open('/home/dju/lancer-legacy/data/crux-mds-duc04-runs/bm25-crux-mds-duc04.run', 'r') as f:
    for line in f:
